...
// RUN: %clang_cc1 -load %llvmshlibdir/MamaevaRenamePlugin%pluginext -add-plugin mamaeva-rename-plugin\
// RUN: -plugin-arg-mamaeva-rename-plugin OldName="A" -plugin-arg-mamaeva-rename-plugin NewName="B" %t/test1.cpp 
...
// RUN: %clang_cc1 -load %llvmshlibdir/MamaevaRenamePlugin%pluginext -add-plugin mamaeva-rename-plugin\
// RUN: -plugin-arg-mamaeva-rename-plugin OldName="C" -plugin-arg-mamaeva-rename-plugin NewName="D" %t/test2.cpp
...
// RUN: %clang_cc1 -load %llvmshlibdir/MamaevaRenamePlugin%pluginext -add-plugin mamaeva-rename-plugin\
// RUN: -plugin-arg-mamaeva-rename-plugin OldName="func1" -plugin-arg-mamaeva-rename-plugin NewName="newFunc" %t/test3.cpp 
...
// RUN: %clang_cc1 -load %llvmshlibdir/MamaevaRenamePlugin%pluginext -add-plugin mamaeva-rename-plugin\
// RUN: -plugin-arg-mamaeva-rename-plugin OldName="notFunc" -plugin-arg-mamaeva-rename-plugin NewName="newFunc" %t/test4.cpp 
