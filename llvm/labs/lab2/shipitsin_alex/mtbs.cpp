...
PassPluginLibraryInfo getShipitsinMTBSPluginPluginInfo() {
  return {LLVM_PLUGIN_API_VERSION, "ShipitsinMTBSPlugin", LLVM_VERSION_STRING,
          [](PassBuilder &PB) {
            PB.registerPipelineParsingCallback(registerPipeLine);
          }};
}

#ifndef LLVM_ShipitsinMTBSPLUGIN_LINK_INTO_TOOLS
extern "C" LLVM_ATTRIBUTE_WEAK PassPluginLibraryInfo llvmGetPassPluginInfo() {
  return getShipitsinMTBSPluginPluginInfo();
}
#endif
