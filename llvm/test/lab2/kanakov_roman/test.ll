; RUN: opt -load-pass-plugin=%llvmshlibdir/kanakov_bit_shift%shlibext -passes=kanakov-bitwise-shift -S %s | FileCheck %s

define dso_local noundef i32 @foo1() #0 {
...
define dso_local noundef i32 @foo2() #0 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  ...
  ret i32 %6
  ; CHECK-LABEL: @foo
  ; CHECK: %4 = mul nsw i32 %3, 3
  ; CHECK: %6 = mul nsw i32 %5, 3
